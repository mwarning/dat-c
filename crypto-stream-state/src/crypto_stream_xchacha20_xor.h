#ifndef CRYPTO_STREAM_XCHACHA20_XOR_H
#define CRYPTO_STREAM_XCHACHA20_XOR_H 1
...
#define crypto_stream_xchacha20_xor_KEYBYTES crypto_stream_xchacha20_KEYBYTES
#define crypto_stream_xchacha20_xor_NONCEBYTES crypto_stream_xchacha20_NONCEBYTES

#define crypto_stream_xchacha20_BLOCKBYTES 64

// Packing? Alignment?

typedef struct crypto_stream_xchacha20_xor_state {
    uint8_t nonce[crypto_stream_xchacha20_NONCEBYTES];
    uint8_t key[crypto_stream_xchacha20_KEYBYTES];
    uint8_t next_block[crypto_stream_xchacha20_BLOCKBYTES];
    uint8_t remainder;
    uint64_t block_counter;
} crypto_stream_xchacha20_xor_state;
